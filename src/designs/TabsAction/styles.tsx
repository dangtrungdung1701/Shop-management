...
export const Title = styled.h3<{ active: boolean; length: number }>`
  ${tw`flex font-medium text-xl items-center gap-1 py-1 cursor-default  border-primary-1 border-b-4 flex-shrink-0`}
...
export const ListTitle = styled(Tab.List)`
  ${tw`flex items-center gap-2.5 font-bold border-b-2 border-neutral-4 text-xxl overflow-auto`}
`;
